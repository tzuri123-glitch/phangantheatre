      ...
      <main className="container mx-auto px-4 py-6">
        {tab === 'dashboard' && (
          <Dashboard
            students={students}
            payments={payments}
            onAddStudent={() => toast.info('פיצ\'ר בפיתוח')}
          />
        )}
        ...
        {tab === 'students' && (
          <Students
            ...
            onAddStudent={() => toast.info('פיצ\'ר בפיתוח')}
            onEditStudent={() => toast.info('פיצ\'ר בפיתוח')}
        ...
        {tab === 'payments' && (
          <Payments
            ...
            students={students}
            sessions={sessions}
            onAddPayment={() => toast.info('פיצ\'ר בפיתוח')}
            onEditPayment={() => toast.info('פיצ\'ר בפיתוח')}
        ...
        {tab === 'attendance' && (
          <Attendance
            ...
            students={students}
            payments={payments}
            onCreateSession={() => toast.info('פיצ\'ר בפיתוח')}
            onEditSession={() => toast.info('פיצ\'ר בפיתוח')}
